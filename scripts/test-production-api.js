...
async function testProductionAPI() {
  ...
  try {
    ...
    await page.goto('https://exam-preparation-system.vercel.app', {
        ...
        const response = await page.evaluate(async () => {
          try {
            const res = await fetch(
              'https://exam-preparation-system.vercel.app/api/health',
            )
    ...
    if (apiResponse) {
      ...
      for (const endpoint of endpoints) {
        ...
        console.log(
          ...
          testResponse.body?.substring(0, 100) || testResponse.error,
        )
      }
    }
